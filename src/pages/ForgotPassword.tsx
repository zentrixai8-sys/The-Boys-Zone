...
import { Mail, Lock, Loader2, Eye, EyeOff, KeyRound, CheckCircle2, ShieldCheck } from 'lucide-react';
          ...
          <AnimatePresence mode="wait">
            {step === 'email' ? (
              ...
              >
                ...
                <div style={{ transform: "translateZ(30px)", transformStyle: "preserve-3d" }} className="bg-white/10 backdrop-blur-3xl border border-white/30 rounded-[32px] p-8 md:p-10 shadow-[0_30px_60px_rgba(5,31,32,0.4)] relative overflow-hidden text-center">
                  ...
                  <div className="w-16 h-16 bg-[#0B2B26] rounded-full flex items-center justify-center mb-6 mx-auto shadow-xl shadow-[#051F20]/30 relative z-10">
                    <KeyRound className="w-8 h-8 text-[#DAF1DE]" />
                  </div>

                  <h1 className="text-2xl font-black text-[#051F20] tracking-tight uppercase relative z-10 drop-shadow-sm">Recovery</h1>
                  <p className="text-[11px] font-bold text-[#235347] uppercase tracking-[0.2em] mt-2 mb-8 relative z-10">Request a recovery code</p>

                  <form onSubmit={handleSendOtp} className="space-y-6 relative z-10" style={{ transform: "translateZ(40px)" }}>
                    ...
                    <motion.button 
                      ...
                      type="submit" 
                      disabled={loading}
                      className="w-full py-4 rounded-2xl bg-[#0B2B26] text-[#DAF1DE] text-[13px] font-black uppercase tracking-widest hover:bg-[#051F20] transition-all shadow-xl shadow-[#051F20]/30 flex items-center justify-center gap-2 disabled:opacity-70"
                    >
              ...
              >
                ...
                <div className="bg-white/10 backdrop-blur-3xl border border-white/30 rounded-[32px] p-8 md:p-10 shadow-[0_30px_60px_rgba(5,31,32,0.4)] relative overflow-hidden text-center">
                  ...
                  <h1 className="text-2xl font-black text-[#051F20] mb-2 tracking-tight uppercase relative z-10 drop-shadow-sm">Verify Code</h1>
                  <p className="text-[#235347] font-bold text-[11px] mb-8 uppercase tracking-widest relative z-10 drop-shadow-sm">
                    Code sent to <span className="text-[#051F20]">{email}</span>
                  </p>

                  <form onSubmit={handleVerifyOtpOnly} className="relative z-10">
                  ...
                  <button
                    ...
                    className="mt-6 text-[10px] uppercase font-black tracking-[0.2em] text-white hover:text-[#DAF1DE] transition-colors relative z-10 drop-shadow-md"
                  >
                    ← Change Email
                  </button>
                </div>
              ...
              >
                ...
                <div className="bg-white/10 backdrop-blur-3xl border border-white/30 rounded-[32px] p-8 md:p-10 shadow-[0_30px_60px_rgba(5,31,32,0.4)] relative overflow-hidden text-center">
                  ...
                  <div className="w-16 h-16 bg-[#0B2B26] rounded-full flex items-center justify-center mb-6 mx-auto shadow-xl shadow-[#051F20]/30 relative z-10">
                    <ShieldCheck className="w-8 h-8 text-[#DAF1DE]" />
                  </div>

                  <h1 className="text-2xl font-black text-[#051F20] tracking-tight uppercase relative z-10 drop-shadow-sm">New Password</h1>
                  <p className="text-[11px] font-bold text-[#235347] uppercase tracking-[0.2em] mt-2 mb-8 relative z-10">Set your resilient access code</p>
